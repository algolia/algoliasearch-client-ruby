...
Create now a new machine, set it up a default and connect your shell to it (here we use zsh. The commands should anyway be displayed in each steps' output)
