  ...
  class TopSearchWithAnalytics
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Algolia::TopSearchWithAnalytics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Algolia::TopSearchWithAnalytics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @click_through_rate > 1
        invalid_properties.push('invalid value for "click_through_rate", must be smaller than or equal to 1.')
      end

      if @click_through_rate < 0
        invalid_properties.push('invalid value for "click_through_rate", must be greater than or equal to 0.')
      end
      ...
      if @nb_hits.nil?
        invalid_properties.push('invalid value for "nb_hits", nb_hits cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @click_through_rate > 1
      return false if @click_through_rate < 0
    ...
    def click_through_rate=(click_through_rate)
      if click_through_rate.nil?
        fail ArgumentError, 'click_through_rate cannot be nil'
      end

      if click_through_rate > 1
        fail ArgumentError, 'invalid value for "click_through_rate", must be smaller than or equal to 1.'
      end

      if click_through_rate < 0
        fail ArgumentError, 'invalid value for "click_through_rate", must be greater than or equal to 0.'
      end
