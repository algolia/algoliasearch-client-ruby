...
module Algolia
  ...
  class SourceIndex
    ...
    def list_invalid_properties
      ...
      if !@min_hits.nil? && @min_hits < 0
        invalid_properties.push('invalid value for "min_hits", must be greater than or equal to 0.')
      end

      if !@min_letters.nil? && @min_letters < 0
        invalid_properties.push('invalid value for "min_letters", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@min_hits.nil? && @min_hits < 0
      return false if !@min_letters.nil? && @min_letters < 0
      true
    end
