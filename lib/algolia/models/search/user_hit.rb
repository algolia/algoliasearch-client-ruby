...
module Algolia
  module Search
    class UserHit
      ...
      def initialize(attributes = {})
        ...
        attributes = attributes.each_with_object({}) { |(k, v), h|
          if (!self.class.attribute_map.key?(k.to_sym))
            raise(
              ArgumentError,
              "`#{k}` is not a valid attribute in `Algolia::UserHit`. Please check the name to make sure it's valid. List of attributes: " +
      ...
      def hash
        [user_id, cluster_name, nb_records, data_size, algolia_object_id, _highlight_result].hash
      end
