...
module Algolia
  class UserHit
    ...
    def list_invalid_properties
      ...
      if @_highlight_result.nil?
        invalid_properties.push('invalid value for "_highlight_result", _highlight_result cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_highlight_result.nil?
      true
    end
    ...
    def hash
      [user_id, cluster_name, nb_records, data_size, object_id, _highlight_result].hash
    end
