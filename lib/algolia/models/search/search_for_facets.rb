  ...
  class SearchForFacets
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Algolia::SearchForFacets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Algolia::SearchForFacets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sum_or_filters_scores')
        ...
        self.sum_or_filters_scores = false
      end
      ...
      if attributes.key?(:'faceting_after_distinct')
        ...
        self.faceting_after_distinct = false
      end
      ...
      if attributes.key?(:'around_lat_lng_via_ip')
        ...
        self.around_lat_lng_via_ip = false
      end
      ...
      if attributes.key?(:'personalization_impact')
        ...
        self.personalization_impact = 100
      end
    ...
    def list_invalid_properties
      ...
      if !@length.nil? && @length > 1000
        invalid_properties.push('invalid value for "length", must be smaller than or equal to 1000.')
      end

      if !@length.nil? && @length < 1
        invalid_properties.push('invalid value for "length", must be greater than or equal to 1.')
      end

      if !@minimum_around_radius.nil? && @minimum_around_radius < 1
        invalid_properties.push('invalid value for "minimum_around_radius", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@length.nil? && @length > 1000
      return false if !@length.nil? && @length < 1
      return false if !@minimum_around_radius.nil? && @minimum_around_radius < 1
