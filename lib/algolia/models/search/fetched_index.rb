  ...
  class FetchedIndex
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'number_of_pending_tasks')
        ...
        self.number_of_pending_tasks = 0
      end
    ...
    def list_invalid_properties
      ...
      if @last_build_time_s.nil?
        invalid_properties.push('invalid value for "last_build_time_s", last_build_time_s cannot be nil.')
      end

      if @number_of_pending_tasks.nil?
        invalid_properties.push('invalid value for "number_of_pending_tasks", number_of_pending_tasks cannot be nil.')
      end

      if @pending_task.nil?
        invalid_properties.push('invalid value for "pending_task", pending_task cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_build_time_s.nil?
      return false if @number_of_pending_tasks.nil?
      return false if @pending_task.nil?
      true
    end
