  ...
  class HighlightResultOption
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Algolia::HighlightResultOption` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Algolia::HighlightResultOption`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @match_level.nil?
        invalid_properties.push('invalid value for "match_level", match_level cannot be nil.')
      end

      if @matched_words.nil?
        invalid_properties.push('invalid value for "matched_words", matched_words cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @match_level.nil?
      return false if @matched_words.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fully_highlighted == o.fully_highlighted
    end
