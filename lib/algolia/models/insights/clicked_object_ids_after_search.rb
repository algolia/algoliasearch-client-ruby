  ...
  class ClickedObjectIDsAfterSearch
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Algolia::ClickedObjectIDsAfterSearch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Algolia::ClickedObjectIDsAfterSearch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @positions.length > 20
        invalid_properties.push('invalid value for "positions", number of items must be less than or equal to 20.')
      end

      if @positions.length < 1
        invalid_properties.push('invalid value for "positions", number of items must be greater than or equal to 1.')
      end
      ...
      if @query_id.to_s.length > 32
        invalid_properties.push('invalid value for "query_id", the character length must be smaller than or equal to 32.')
      end

      if @query_id.to_s.length < 32
        invalid_properties.push('invalid value for "query_id", the character length must be great than or equal to 32.')
      end

      pattern = Regexp.new(/[0-9a-f]{32}/)
      if @query_id !~ pattern
        invalid_properties.push("invalid value for \"query_id\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @positions.length > 20
      return false if @positions.length < 1
      return false if @query_id.nil?
      return false if @query_id.to_s.length > 32
      return false if @query_id.to_s.length < 32
      return false if @query_id !~ Regexp.new(/[0-9a-f]{32}/)
    ...
    def positions=(positions)
      ...
      if positions.length > 20
        fail ArgumentError, 'invalid value for "positions", number of items must be less than or equal to 20.'
      end

      if positions.length < 1
        fail ArgumentError, 'invalid value for "positions", number of items must be greater than or equal to 1.'
      end
    ...
    def query_id=(query_id)
      ...
      if query_id.to_s.length > 32
        fail ArgumentError, 'invalid value for "query_id", the character length must be smaller than or equal to 32.'
      end

      if query_id.to_s.length < 32
        fail ArgumentError, 'invalid value for "query_id", the character length must be great than or equal to 32.'
      end

      pattern = Regexp.new(/[0-9a-f]{32}/)
      if query_id !~ pattern
        fail ArgumentError, "invalid value for \"query_id\", must conform to the pattern #{pattern}."
      end
