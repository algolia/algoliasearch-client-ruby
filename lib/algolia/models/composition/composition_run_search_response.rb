    ...
    class CompositionRunSearchResponse
      ...
      def self.types_mapping
        {
          ...
          :applied_rules => :"Array<CompositionRunAppliedRules>"
        }
      end
      ...
      def initialize(attributes = {})
        if (!attributes.is_a?(Hash))
          raise(
            ArgumentError,
            "The input argument (attributes) must be a hash in `Algolia::CompositionRunSearchResponse` initialize method"
          )
        end
      ...
      def hash
        [algolia_object_id, applied_rules].hash
      end
