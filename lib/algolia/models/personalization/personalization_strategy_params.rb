  ...
  class PersonalizationStrategyParams
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Algolia::PersonalizationStrategyParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Algolia::PersonalizationStrategyParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @event_scoring.nil?
        invalid_properties.push('invalid value for "event_scoring", event_scoring cannot be nil.')
      end

      if @facet_scoring.nil?
        invalid_properties.push('invalid value for "facet_scoring", facet_scoring cannot be nil.')
      end

      if @personalization_impact.nil?
        invalid_properties.push('invalid value for "personalization_impact", personalization_impact cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @event_scoring.nil?
      return false if @facet_scoring.nil?
      return false if @personalization_impact.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          event_scoring == o.event_scoring &&
          facet_scoring == o.facet_scoring &&
