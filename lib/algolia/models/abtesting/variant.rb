  ...
  class Variant
    ...
    def list_invalid_properties
      ...
      if @add_to_cart_count.nil?
        invalid_properties.push('invalid value for "add_to_cart_count", add_to_cart_count cannot be nil.')
      end

      if @add_to_cart_rate.nil?
        invalid_properties.push('invalid value for "add_to_cart_rate", add_to_cart_rate cannot be nil.')
      end

      if @average_click_position.nil?
        invalid_properties.push('invalid value for "average_click_position", average_click_position cannot be nil.')
      end
      ...
      if @click_through_rate.nil?
        invalid_properties.push('invalid value for "click_through_rate", click_through_rate cannot be nil.')
      end

      if @conversion_count.nil?
        invalid_properties.push('invalid value for "conversion_count", conversion_count cannot be nil.')
      end

      if @conversion_rate.nil?
        invalid_properties.push('invalid value for "conversion_rate", conversion_rate cannot be nil.')
      end
      ...
      if @no_result_count.nil?
        invalid_properties.push('invalid value for "no_result_count", no_result_count cannot be nil.')
      end

      if @purchase_count.nil?
        invalid_properties.push('invalid value for "purchase_count", purchase_count cannot be nil.')
      end

      if @purchase_rate.nil?
        invalid_properties.push('invalid value for "purchase_rate", purchase_rate cannot be nil.')
      end

      if @search_count.nil?
        invalid_properties.push('invalid value for "search_count", search_count cannot be nil.')
      end

      if @tracked_search_count.nil?
        invalid_properties.push('invalid value for "tracked_search_count", tracked_search_count cannot be nil.')
      end

      if @traffic_percentage.nil?
        invalid_properties.push('invalid value for "traffic_percentage", traffic_percentage cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @add_to_cart_count.nil?
      return false if @add_to_cart_rate.nil?
      return false if @average_click_position.nil?
      return false if @click_count.nil?
      return false if @click_through_rate.nil?
      return false if @conversion_count.nil?
      return false if @conversion_rate.nil?
      return false if @currencies.nil?
      return false if @description.nil?
      return false if @index.nil?
      return false if @no_result_count.nil?
      return false if @purchase_count.nil?
      return false if @purchase_rate.nil?
      return false if @search_count.nil?
      return false if @tracked_search_count.nil?
      return false if @traffic_percentage.nil?
