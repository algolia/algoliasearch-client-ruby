...
module Algolia
  class UsageClient
    ...
    # @param start_date [String] Start date in ISO 8601 format of the time period to analyze. (required)
    # @param end_date [String] End date in ISO 8601 format of the time period to analyze. (required)
