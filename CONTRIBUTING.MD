...
algolia gem is developed in Ruby.
...
We ask that for each fix or feature submitted, you add at least once test demonstrating its behaviour. As you will need to use your own Algolia
